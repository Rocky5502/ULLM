...
Write-Host "[1/13] Hard audit gates against frozen manifests"
...
Write-Host "[4/13] RQ2 repeated-sampling uncertainty"
...
Write-Host "[5/13] Unified RQ2 failure ranking across all four signals"
...
Write-Host "[6/13] RQ2 verb-cluster ranking intervals"
...
Write-Host "[7/13] Paired A-C / B-D semantic updates"
...
Write-Host "[8/13] Prompt and label-order robustness"
...
Write-Host "[9/13] RQ3 threshold-realizable risk-coverage"
...
Write-Host "[10/13] RQ3 cached selective-verifier policies"
...
Write-Host "[11/13] Publication vector figures"
...
Write-Host "[12/13] Auto-generate LaTeX result tables (no hand-copied numbers)"
...
Write-Host "[13/13] Freeze dual-SHA analysis provenance"
python scripts/freeze_analysis_provenance.py --out results/processed/analysis_manifest.json

Write-Host "Analysis complete. Every manuscript number is generated from PASS-audited artifacts and sealed to raw-run + analysis-code provenance."
