...
Write-Host "[1/12] Hard audit gates against frozen manifests"
...
Write-Host "[4/12] RQ2 repeated-sampling uncertainty"
...
Write-Host "[5/12] Unified RQ2 failure ranking across all four signals"
...
Write-Host "[6/12] RQ2 verb-cluster ranking intervals"
