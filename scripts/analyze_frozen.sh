...
echo "[1/13] Hard audit gates against frozen manifests"
...
echo "[4/13] RQ2 repeated-sampling uncertainty"
...
echo "[5/13] Unified RQ2 failure ranking"
...
echo "[6/13] RQ2 verb-cluster ranking intervals"
...
echo "[7/13] Paired A-C / B-D semantic updates"
...
echo "[8/13] Prompt and label-order robustness"
...
echo "[9/13] RQ3 threshold-realizable risk-coverage"
...
echo "[10/13] RQ3 cached selective-verifier policies"
...
echo "[11/13] Publication vector figures"
...
echo "[12/13] Auto-generate LaTeX result tables"
...
echo "[13/13] Freeze dual-SHA analysis provenance"
python scripts/freeze_analysis_provenance.py --out results/processed/analysis_manifest.json

echo "Analysis complete. Every manuscript number is generated from PASS-audited artifacts and sealed to raw-run + analysis-code provenance."
